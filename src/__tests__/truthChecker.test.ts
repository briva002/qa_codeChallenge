describe("checking for truth", () => {
  test("are the littleNumbers < bigNumbers?", () => {
    ...
    let littleNumbers: Array<number> = [-1, 0 , 4];
    let bigNumbers: Array<number> = [100, 200, 305];
  ...
  test("wordToCheck is a palindrome, case and everything", () => {
    let wordToCheck = "pie chart"; // yeah, replace the value to pass the test.
  ...
  test("there is a sequence to this test", () => {
    let values: Array<any> = ["I am string.", true,1]; // set values here - the array will take any type or combo of types.
